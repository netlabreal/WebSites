...
$nid = Input::return_get('nid')!=''?Input::return_get('nid'):0;
?>
<!DOCTYPE html>
<html lang="en">
<head lang="en">
            ...
            <div class="col-md-8 col-xs-8 col-sm-8">
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="active" ><a href="info.php">Полезная информация</a></li>
...
<div class="container-fluid" id="main_content">
    <div class="row">
        ...
        <div class="col-md-8 col-xs-12 col-sm-12">
            <ol class="breadcrumb"><li>Полезная информация</li></ol>
            <div id="info">
            </div>
        </div>
    ...
    $(function () {
            ...
            $.ajax({
                ...
                success:function(data){
                    if(data.length!=0){
                        ...
                        {
                            if(data[i]['img']==0){foto = '../img/m1.jpg';}else{foto = '../img/news/'+data[i]['id']+'.jpg';}
                            $('#info').append('<div class="panel panel-default">'+
                                              '<div class="panel-heading" id="head_news">'+data[i]['caption']+'</div>'+
                                              '<div class="panel-body">'+
                                              '<div id="pan_img"><img class="img-responsive" src="'+foto+'"></div>'+
                                              '<div id="sss_txt">'+data[i]['txt'].slice(0,250)+'...</div>'+
                                              '<br>'+
                                              '<div id="sss"><a href="info.php?nid='+data[i]['id']+'">Подробнее</a></div></div></div>'
                            );
                        }
                    }
                },
        ...
        function Getinfo(nid){
            $.ajax({
                ...
                success:function(data){
                    if(data.length!=0){
                        if(data[0]['img']==0){foto = '../img/m1.jpg';}else{foto = '../img/news/'+data[0]['id']+'.jpg';}
                        $('#info').html('');
                        $('#info').append('<div class="panel panel-default">'+
                                '<div class="panel-heading" id="head_news">'+data[0]['caption']+'</div>'+
                                '<div class="panel-body">'+
                                '<div id="pan_img"><img class="img-responsive" src="'+foto+'"></div>'+
                                '<div id="sss_txt">'+data[0]['txt']+'</div>'
                        );
                    }
                },
                error:function(result){
