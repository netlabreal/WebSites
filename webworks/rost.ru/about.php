            ...
            <div class="col-md-8 col-xs-8 col-sm-8">
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="active" ><a href="about.php">Контакты</a></li>
                    </ul>
                </div>
            </div>
...
<div class="container-fluid" id="main_content">
    <div class="row">
        ...
        <div class="col-md-8 col-xs-12 col-sm-12">
            ...
            <ol class="breadcrumb"><li>ОСТ - Юридическое бюро недвижимости</li></ol>


            <div class="col-md-8 col-xs-12 col-sm-12">
                <div class="panel panel-default" id="mymap">
                    <div class="panel-body">
                        <img class="img-responsive" src="https://api-maps.yandex.ru/services/constructor/1.0/static/?sid=NmoFCLBwKlIP8oJbyw_OLa0F356KxfF-&width=522&height=370&lang=ru_RU&sourceType=constructor" alt=""/>
                    </div>
                </div>
            </div>
            <div class="col-md-4 col-xs-12 col-sm-12">
                <div class="panel panel-default">
                    <div class="panel-body">
                        <div ><i class="fa fa-building-o rr_txt"></i>  г. Находка ул. Гагарина д. 8</div>
                        <div ><i class="fa fa-phone rr_txt"></i>  8(423) 62-64-30</div>
                        <div ><i class="fa fa-phone rr_txt"></i>  8-914-713-18-02</div>
                        <div ><i class="fa fa-phone rr_txt"></i>  8-924-253-57-72</div>
