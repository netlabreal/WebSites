        ...
        <div class="col-xs-12">
            ...
            <div class="panel panel-default" id ="m_panel">
             ...
             <ul class="nav nav-tabs" id="doppanel">
                ...
                <li><a href="#zayavki" data-toggle="tab" id="ss_z">Сообщения</a></li>
...
////////////////////////////////////////////////////////////////
	function getStat(){
		$.ajax({
			...
			success:function(data){
				if(data!=null){
					$('#stat').html("");$('#stat').append('<br><br><div class="list-group"><a href="#" class="list-group-item active">'+
					'<span class="glyphicon glyphicon-star"></span> Статистика <span class="badge"></span></a>');
					for(var i = 0;i<data.length;i++)
					{
						$('#stat').append('<a href="#" class="list-group-item">'+
						'<span class="glyphicon glyphicon-user"></span>'+data[i]['name']+' <span class="badge">'+data[i]['kolvo']+'</span></a>');
					}
					$('#stat').append('<br><div class="btn btn-primary" id="st_exit">Очистить статистику</div><br><br>');

					$('#st_exit').click(function(){
						DelStat();
						getStat();
					});
